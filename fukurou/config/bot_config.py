...
class FukurouConfig:
    ...
    def getClientId(self):
        ...
        self.logger.debug(f"Read client_id from {self.FILE_PATH}: " + deserialized["client_id"])
    ...
    def getPermissions(self):
        ...
        deserialized = json.loads(json_str)
        self.logger.debug(f"Read permissions from {self.FILE_PATH}: " + deserialized["permissions"])
